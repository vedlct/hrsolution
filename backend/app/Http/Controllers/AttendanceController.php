...
//        }
        ...
        $allEmp=EmployeeInfo::select('id','fkDepartmentId',DB::raw("select CONCAT(COALESCE(firstName),' ',COALESCE(middleName),' ',COALESCE(lastName)) AS empFullname"))->whereNull('resignDate')->get();
