...
<table class="blueTable">
    ...
    @php
        $late=0;$finalLate=0;$offDay=0;$finalOffDay=0;$holiDay=0;$finalholiDay=0;
    @endphp
        ...
        <tr>
           ...
           if($aE->actualJoinDate !=null ){
            ...
            <td style="text-align: center;vertical-align: middle;"width="10">
                {{$allLeave->where('fkEmployeeId',$aE->id)->where('startDate','<=',$startDate)->where('endDate','>=',$endDate)
