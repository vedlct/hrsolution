...
@Component({
  ...
  templateUrl: './create-leave-team.component.html',
  styleUrls: ['./create-leave-team.component.css']
})
export class CreateLeaveTeamComponent implements OnInit {
  ...
  onSubmit(){
    ...
    this.http.post(Constants.API_URL+'team/leave/post'+'?token='+token,this.teamObj).subscribe(data => {
          // console.log(data);
          this.getShift();
